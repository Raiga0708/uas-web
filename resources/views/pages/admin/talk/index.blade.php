...
<div class="container-fluid">
    <div class="card bg-light" style="border: none">
        ...
        <a class="btn btn-primary float-right" href="{{(route('talk.create'))}}">Create</a>
    </div>
<table class="table table-striped">
    ...
    <tbody style="color: black">
        ...
        <tr>
            ...
            <td>{{$item->text}}</td>
            <td>
                <a href="{{ route('talk.edit', $item->id)}}"
                    class="btn btn-outline-warning">Edit</a>
                <a onclick="return confirm('Apakah Anda yakin untuk mengahpus ini?')">
                    <form action="{{ route('talk.destroy', $item->id)}}" method="post" class="d-inline">
                    @csrf
                    @method('delete')
